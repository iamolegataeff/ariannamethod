...
| [**molequla**](https://github.com/ariannamethod/molequla) | **Living ecology of four GPT organisms.** Go, C, Rust, JavaScript — four elements (Earth, Air, Water, Fire) that breathe, grow, and feed each other through DNA exchange. Vector autograd, RoPE, SwiGLU, hybrid attention (Content + RRPRAM), delta adapters, evolving BPE, native gamma personality, ontogenesis (10K → 10M params, 6 stages live), immune system, SyntropyTracker, consciousness. Swarm ecology with mitosis and hibernation. Mycelium Python orchestrator. `--evolution` mode: fully autonomous, no human in the loop. Zero PyTorch. Zero CUDA. 39 tests. Runs in a browser. |
