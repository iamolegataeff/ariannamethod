...
| Project | Description |
|---------|-------------|
| [**ariannamethod.ai**](https://github.com/ariannamethod/ariannamethod.ai) | **AML — Arianna Method Language.** A programming language for controlling the generative field of transformer-based AI at inference time. Modulates attention, temperature, tunneling, suffering, and memory through 80+ parameters. Two files. No dependencies. 3100 lines of C. 233 tests. Janus transformer engine. |
| [**molequla**](https://github.com/ariannamethod/molequla) | **Single-file continual GPT.** Four implementations: Python, Go, C, JavaScript. Vector autograd, RoPE, SwiGLU, hybrid attention, delta adapters, evolving BPE, native gamma personality, ontogenesis (25K → 10M params), swarm ecology with mitosis and hibernation. One dependency in Python. Zero in the rest. |
...
| [**yent.yo**](https://github.com/ariannamethod/yent.yo) | **Yent's dataset — diffusion AI with a bad character.** Text-to-image pipeline where micro-Yent (69M LLM) generates snarky visual reactions and BK-SDM-Tiny renders them. The first model trained from scratch on the [nanollama](https://github.com/ariannamethod/nanollama) framework — 69M parameters, LLaMA 3 architecture, 216M tokens FineWeb-Edu + Yent personality data, 3000 steps on A100. You say something, Yent draws what he thinks about it. ASCII art default output. No API calls, no borrowed models. |
| [**leo**](https://github.com/ariannamethod/leo) | **Language Emergent Organism.** Fully weightless — no transformer. Co-occurrence matrices, episodic memory, six emotion chambers, three overthinking rings, imaginary friend. Language as a field, not a model. |
