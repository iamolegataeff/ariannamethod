...
Future<int> fetchSpeechAndPlay(
  ...
  try {
    ...
    // Determine voice based on webhook URL or default to female voice
    String selectedVoice = voice ?? 'nova'; // Default to female voice (Arianna)
    
    String body = json.encode(
        {'model': 'tts-1-hd', 'input': promptText, 'voice': selectedVoice, 'speed': '1.0'});
