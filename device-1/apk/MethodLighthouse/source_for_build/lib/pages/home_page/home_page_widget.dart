    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().sessionID == '') {
        ...
        FFAppState().addToMessageHistory(MessageStruct(
          text: 'Arianna Method Lighthouse App. #Async Field Forever',
          blueBubble: false,
        ));
      }
    });
                                                  ...
                                                  if (_model.getResponseAPICall!.succeeded) {
                                                    ...
                                                    try {
                                                      ...
                                                      unawaited(
                                                        () async {
                                                          try {
                                                            // Determine voice based on webhook URL
                                                            String voice = 'nova'; // Default female voice for Arianna
                                                            if (FFAppState().webhookURL.contains('8002')) {
                                                              voice = 'onyx'; // Male voice for Monday
                                                            }
